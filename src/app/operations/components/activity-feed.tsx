...
import { ArrowDown, ArrowUp, Briefcase, Check, DollarSign, Server, User } from 'lucide-react';
...
const getIconForActivity = (description: string) => {
    ...
    if (description.includes('Server costs')) return <Server className="h-4 w-4 text-orange-500" />;
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>A live feed of events from across your businesses.</CardDescription>
      </CardHeader>
      <CardContent>
            ...
            <div key={activity.id} className="flex gap-3">
              ...
              <div className="flex-1 space-y-1">
                <p className="text-sm">
                  ...
                  <span className="text-muted-foreground"> &mdash; {activity.business}</span>
                </p>
                <div className="flex items-center justify-between">
                    <p className="text-sm font-medium text-muted-foreground">{activity.detail}</p>
