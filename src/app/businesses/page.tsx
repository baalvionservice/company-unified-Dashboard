...
export default function BusinessesPage() {
    const [selectedBusiness, setSelectedBusiness] = useState<Business>(businessesData[0] as Business);
            ...
            <div className="md:col-span-1">
                 ...
                 <div className="space-y-1">
                    {(businessesData as Business[]).map(biz => {
                        ...
                        return (
                            <Card key={biz.id} onClick={() => setSelectedBusiness(biz)} className={cn("p-3 cursor-pointer", selectedBusiness.id === biz.id ? 'bg-muted' : 'hover:bg-muted/50')}>
