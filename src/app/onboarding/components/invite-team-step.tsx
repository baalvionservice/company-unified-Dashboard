...
export default function InviteTeamStep({ onNext, onBack, updateFormData, formData }: InviteTeamStepProps) {
  const [invites, setInvites] = useState(formData.invites || [{ email: '', role: 'Co-Founder' }]);
