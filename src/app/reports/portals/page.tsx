    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        <div className="lg:col-span-1">
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2"><PlusCircle /> Create New Portal</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
               <div className="space-y-2">
                <Label htmlFor="portal-name">Portal Name</Label>
                <Input id="portal-name" placeholder="e.g., Q4 Investor Update" />
              </div>
               <div className="space-y-2">
                <Label htmlFor="investor-name">Investor Name</Label>
                <Input id="investor-name" placeholder="e.g., General Partners" />
              </div>
              <div className="space-y-2">
        ...
        <div className="lg:col-span-2">
           <Card>
            <CardHeader>
                ...
                <CardDescription>Manage previously created investor portals.</CardDescription>
            </CardHeader>
            <CardContent>
                        ...
                        <TableBody>
                            {portalsData.map(portal => (
                                <TableRow key={portal.id}>
                                    ...
                                    <TableCell>{portal.expires ? format(new Date(portal.expires), 'PP') : 'Never'}</TableCell>
                                    <TableCell>{portal.pin ? 'Yes' : 'No'}</TableCell>
                                    <TableCell className="text-right">
                                        <Button variant="outline" size="sm" onClick={() => handleCopy(portal.url)}>
