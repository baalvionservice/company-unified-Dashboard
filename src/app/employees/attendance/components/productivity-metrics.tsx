...
export default function ProductivityMetrics() {
  ...
  const tasksAchievement = (productivity.tasksCompleted / productivity.tasksTarget) * 100;
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="md:col-span-1 space-y-6">
                <div className="space-y-2">
                    <p className="text-sm font-medium flex items-center gap-2"><Target className="h-4 w-4"/> Tasks Completed</p>
                    <Progress value={tasksAchievement} />
                    <p className="text-xs text-muted-foreground">{productivity.tasksCompleted} / {productivity.tasksTarget} tasks</p>
                </div>
                 ...
                 <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="font-bold">{productivity.meetingsThisWeek} Total</p>
                    </div>
                </div>
            </div>
                    ...
                    <Table>
                        ...
                        <TableBody>
                            {productivity.leaderboard.map((item, index) => {
                                ...
                                const userImage = PlaceHolderImages.find(p => p.id === employee.imageId);
                                return (
                                    <TableRow key={item.employeeId}>
                                        ...
                                        <TableCell className="flex items-center gap-1"><Star className="h-4 w-4 text-yellow-400" /> {item.score}</TableCell>
