...
export default function CoFounderView() {
  return (
    <div className="space-y-8">
      <div className="mb-6">
        <h1 className="text-3xl font-bold tracking-tight">Co-Founder Dashboard</h1>
        <p className="text-muted-foreground">
          Manage your shared ventures.
        </p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Shared Businesses</CardTitle>
            <Briefcase className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">2</div>
            <p className="text-xs text-muted-foreground">TechCorp India, FinanceHub USA</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Joint Monthly Revenue</CardTitle>
        ...
        <div className="lg:col-span-1">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Items needing your review and approval.</CardDescription>
            </CardHeader>
            <CardContent>
              <ul className="space-y-4">
                ...
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">FinanceHub USA</p>
                  </div>
                </li>
                <li className="flex items-start gap-4">
                   <Clock className="h-5 w-5 mt-1 text-yellow-500" />
