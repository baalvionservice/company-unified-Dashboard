                        ...
                        return (
                            <Card key={biz.id}>
                                ...
                                <CardContent className="space-y-2 text-sm">
                                    <div className="flex justify-between"><span>Created:</span> <span className="font-medium">{format(new Date(), 'PP')}</span></div>
                                    <div className="flex justify-between"><span>Plan Tier:</span> <Badge variant="outline">Enterprise</Badge></div>
                                    <div className="flex justify-between"><span>Status:</span> <Badge variant="default" className="bg-green-100 text-green-800">{biz.status}</Badge></div>
                                </CardContent>
                            </Card>
                        )
                    })}
