        ...
        <>
            ...
            <CardHeader>
                <div className="flex items-center justify-between">
                    ...
                    <Button onClick={() => setInviteModalOpen(true)}><PlusCircle className="mr-2" /> Invite User</Button>
                </div>
            </CardHeader>
            <CardContent>
                    ...
                    <TableHeader>
                        ...
                        <TableHead className="w-[50px]">
                            <Checkbox
                                ...
                                checked={selectedUsers.length === usersData.length || (selectedUsers.length > 0 ? 'indeterminate' : false)}
                             />
                        </TableHead>
                        ...
                        {usersData.map(user => {
                            ...
                            return (
                                <TableRow key={user.id}>
                                    ...
                                    <TableCell><Badge variant="default" className="bg-green-100 text-green-800">Active</Badge></TableCell>
